...
void AppClass::InitVariables(void)
{
	...
	broadphase = new btDbvtBroadphase(); //a list of potentially colliding object pairs to check in depth later
	...
	//Cube
	fallShape = new btBoxShape(btVector3(0.5, 0.5, 0.5)); //cube drawn around the object to handle collisions in that dont need more complexcollision checks
	btScalar mass = 1;
...
void AppClass::Update(void)
{
	...
	//Plane doesnt actually do anything it just gets drawn where the bullet physics specifies the world floor is
