...
#pragma region YOUR CODE GOES HERE
	...
	m_m4Earth = glm::rotate(IDENTITY_M4, m_fEarthTimer, vector3(0.0f, 1.0f, 0.0f)) * distanceEarth * glm::rotate(IDENTITY_M4,m_fEarthTimer,vector3(0.0f,1.0f,0.0f)) * rotateX;
	m_m4Earth = glm::rotate(m_m4Earth, m_fEarthTimer, vector3(0.0f, 1.0f, 0.0f));

	//Calculate the position of the Moon
	m_m4Moon = glm::rotate(m_m4Earth, m_fMoonTimer, vector3(0.0f, 0.0f, 1.0f)) * distanceMoon * rotateY;
#pragma endregion
