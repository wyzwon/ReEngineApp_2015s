...
//System Class
class ReEngDLL BOClass
{
	float m_fRadius = 0.0f; //Radius of the Bounding Object

	PrimitiveManagerSingleton* m_pPrimitiveMngr = nullptr; //Primitive manager to render objects
...
public:
	...
	OUTPUT: class object
	*/
	BOClass(std::vector<vector3> a_lVectorList);
	/*
	USAGE: Copy Constructor
	ARGUMENTS: class object to copy
	OUTPUT: class object instance
	*/
	BOClass(BOClass const& other);
	/*
	USAGE: Copy Assignment Operator
	ARGUMENTS: class object to copy
	OUTPUT: ---
	*/
	BOClass& operator=(BOClass const& other);
	/*
	USAGE: Destructor
	ARGUMENTS: ---
	OUTPUT: ---
	...
	*/
	...
	ARGUMENTS:
	- BOClass* const a_pOther -> Other object to check collision with
	OUTPUT: check of the collision
	*/
	bool IsColliding(BOClass* const a_pOther);
	/*
	...
	*/
	bool SAT(BOClass* const a_pOther);
	/*
...
//EXPIMP_TEMPLATE template class ReEngDLL std::vector<BOClass>;
//EXPIMP_TEMPLATE template class ReEngDLL std::vector<BOClass*>;
